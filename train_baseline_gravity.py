...
parser.add_argument('--start_min', type=int, default=7, help='min starting time for sampling sequence (0-indexed)')
parser.add_argument('--start_max', type=int, default=29, help='max starting time for sampling sequence  (0-indexed)')

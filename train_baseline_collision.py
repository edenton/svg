...
parser.add_argument('--mcs_task', default='CollisionTraining', help='mcs task')
...
parser.add_argument('--start_max', type=int, default=100, help='max starting time for sampling sequence  (0-indexed)')

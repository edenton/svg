...
parser.add_argument('--log_dir', default='/misc/vlgscratch4/FergusGroup/denton/svg_logs/svg_lp/', help='base directory to save logs')
...
parser.add_argument('--n_eval', type=int, default=30, help='number of frames to predict')
...
if opt.model_dir != '':
    ...
    prior = lstm_models.gaussian_lstm(opt.g_dim, opt.z_dim, opt.rnn_size, opt.batch_size)

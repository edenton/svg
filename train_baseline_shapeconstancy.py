...
parser.add_argument('--n_future', type=int, default=21, help='number of frames to predict')
parser.add_argument('--n_eval', type=int, default=26, help='number of frames to predict at eval time')
parser.add_argument('--start_min', type=int, default=70, help='min starting time for sampling sequence (0-indexed)')
...
parser.add_argument('--is_shape_constancy', type=bool, default=True, help='flag indicating using shape constancy dataset')
